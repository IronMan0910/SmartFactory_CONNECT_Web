...
import WhiteBoxLanding from "./pages/feedback/WhiteBoxLanding";
import PublishedBoardPage from "./pages/feedback/PublishedBoardPage";
import PublishedResponsesManagement from "./pages/Admin/PublishedResponsesManagement";
import DepartmentInboxPage from "./pages/feedback/DepartmentInboxPage";
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route element={<AppLayout />}>
            ...
            />
            <Route
              path="/feedback/opinions"
              element={<PublicIdeasPage />}
            />
            <Route
              path="/feedback/published"
              element={<PublishedBoardPage />}
            />
            <Route
              path="/feedback/published-management"
              element={
                <ProtectedRoute requireAdmin>
                  <PublishedResponsesManagement />
                </ProtectedRoute>
              }
            />
            <Route
              path="/department-inbox"
              element={<DepartmentInboxPage />}
            />
