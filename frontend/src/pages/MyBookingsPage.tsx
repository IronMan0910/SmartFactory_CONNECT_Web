        ...
        <div className="bg-white dark:bg-neutral-900 rounded-xl shadow-sm border border-gray-200 dark:border-neutral-800 p-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            <div
              ...
              className={`p-4 rounded-lg cursor-pointer transition-colors ${filter === 'all'
            ...
            <div
              ...
              className={`p-4 rounded-lg cursor-pointer transition-colors ${filter === 'pending'
                ? 'bg-red-50 dark:bg-red-900/20 border-2 border-red-500 dark:border-red-500'
                : 'bg-gray-50 dark:bg-neutral-800 hover:bg-gray-100 dark:hover:bg-neutral-700'
                }`}
            >
            ...
            <div
              ...
              className={`p-4 rounded-lg cursor-pointer transition-colors ${filter === 'confirmed'
                ? 'bg-red-50 dark:bg-red-900/20 border-2 border-red-500 dark:border-red-500'
                : 'bg-gray-50 dark:bg-neutral-800 hover:bg-gray-100 dark:hover:bg-neutral-700'
                }`}
            >
            ...
            <div
              ...
              className={`p-4 rounded-lg cursor-pointer transition-colors ${filter === 'cancelled'
                ? 'bg-red-50 dark:bg-red-900/20 border-2 border-red-500 dark:border-red-500'
                : 'bg-gray-50 dark:bg-neutral-800 hover:bg-gray-100 dark:hover:bg-neutral-700'
                }`}
            >
            ...
            <div
              ...
              className={`p-4 rounded-lg cursor-pointer transition-colors ${filter === 'rejected'
                ? 'bg-red-50 dark:bg-red-900/20 border-2 border-red-500 dark:border-red-500'
                : 'bg-gray-50 dark:bg-neutral-800 hover:bg-gray-100 dark:hover:bg-neutral-700'
                }`}
            >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    <span
                      ...
                      style={{ backgroundColor: booking.purpose ? MEETING_PURPOSE_COLORS[booking.purpose] : '#6B7280' }}
                    ></span>
                  ...
                  <div className="space-y-1 text-sm text-gray-600 dark:text-gray-400 mb-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>{booking.expected_attendees} {t('booking.attendees_unit')}</span>
                    </div>
                  </div>
